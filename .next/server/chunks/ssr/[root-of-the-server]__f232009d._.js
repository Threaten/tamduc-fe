module.exports = [
"[project]/.next-internal/server/app/teams/page/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
const metadata = {
    title: "Đội ngũ",
    description: "Gặp gỡ đội ngũ y tế đa chuyên khoa: bác sĩ, điều dưỡng, kỹ thuật viên và nhân sự hỗ trợ.",
    openGraph: {
        images: [
            {
                url: "/og-default.png",
...
function groupByRole(list) {
    ...
    const dynamic = Object.keys(grouped).filter((r)=>!order.includes(r));
    const final = [
...
async function TeamPage() {
    ...
    try {
        const loaded = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$queries$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getStaffs"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$page$2d$hero$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
                ...
                subtitle: hero?.teamDescription || "Kỹ năng, tận tâm và phối hợp giữa các chuyên khoa.",
                imageSrc: hero?.teamHero?.url ? `${process.env.ADMIN_API_ENDPOINT}/${hero.teamHero.url}` : undefined,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    roles.map((section)=>{
                        const normalized = section.members.map((m)=>({
                                id: m.id,
                                slug: m.slug,
                                name: m.name,
                                role: m.role,
                                years: m.years ?? undefined,
                                languages: (m.languages || []).filter((l)=>l?.value).map((l)=>({
                                        value: l?.value
                                    })),
                                schedule: [],
                                photo: m.photo?.url ? {
                    ...
                    !roles.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-sm opacity-70",
                        children: "Chưa có dữ liệu nhân sự."
                    }, void 0, false, {
                        fileName: "[project]/app/teams/page.tsx",
                        lineNumber: 106,
                        columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f232009d._.js.map