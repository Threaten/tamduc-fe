module.exports = [
"[project]/.next-internal/server/app/blogs/[slug]/page/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function generateMetadata({ params }) {
    ...
    const { slug } = resolved;
    // Removed debug log
    const loadedData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$queries$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getBlog"])(`${slug}`);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$page$2d$hero$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"], {
                title: post.title,
                subtitle: post.author.name || post.publishedAt ? `${post.author.name ?? ""}${post.publishedAt ? ` • ${new Date(post.publishedAt).toLocaleDateString()}` : ""}` : undefined,
                imageSrc: `${process.env.ADMIN_API_ENDPOINT}/${post.coverImage?.url}`,
                imageFallbackRemotes: (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$remote$2d$images$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["BLOG_REMOTE_CANDIDATES"][slug] ?? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$remote$2d$images$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["HERO_REMOTE_CANDIDATES"].blogs).slice(1),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f8baebd._.js.map